...
function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        // Update
        await axios.put(
          `https://crud-1-9hgx.onrender.com/api/auth/update/${editId}`,
          book,
        );
        ...
        // Create
        await axios.post(
          "https://crud-1-9hgx.onrender.com/api/auth/book",
          book,
        );
  ...
  const getAllbooks = async () => {
    ...
    try {
      const res = await axios.get(
        "https://crud-1-9hgx.onrender.com/api/auth/booklist",
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `https://crud-1-9hgx.onrender.com/api/auth/delete/${id}`,
      );
